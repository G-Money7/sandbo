...
import { serialize, createBlock, pasteHandler, findTransform, getBlockTransforms } from '@wordpress/blocks';
...
export function setClipboardBlocks(event, blocks) {
  ...
  if (wrapperBlockName) {
    _blocks = createBlock(wrapperBlockName, JSON.parse(event.clipboardData.getData('__unstableWrapperBlockAttributes')), _blocks);
  }
