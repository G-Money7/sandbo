 ...
 */
import { getBlockType, getBlockTypes, getBlockVariations, getHookedBlocks, hasBlockSupport, getPossibleBlockTransformations, parse, switchToBlockType, store as blocksStore } from '@wordpress/blocks';
...
const buildBlockTypeItem = (state, {
  ...
  const ignoredHookedBlocks = [...new Set(Object.values(getHookedBlocks(id)).flat())];
  return {
    ...blockItemBase,
