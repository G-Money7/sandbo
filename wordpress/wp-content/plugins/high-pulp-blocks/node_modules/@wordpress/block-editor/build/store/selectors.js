...
exports.getDirectInsertBlock = exports.getClientIdsWithDescendants = exports.getClientIdsOfDescendants = exports.getBlocksByName = exports.getBlocksByClientId = void 0;
...
const __unstableGetBlockWithoutInnerBlocks = exports.__unstableGetBlockWithoutInnerBlocks = (0, _rememo.default)((state, clientId) => {
  const block = state.blocks.byClientId.get(clientId);
  if (!block) {
    return null;
  }
 ...
 */
const __unstableGetClientIdWithClientIdsTree = exports.__unstableGetClientIdWithClientIdsTree = (0, _rememo.default)((state, clientId) => {
 ...
 * @return {Object[]} Client IDs of the post blocks.
 */
const __unstableGetClientIdsTree = exports.__unstableGetClientIdsTree = (0, _rememo.default)((state, rootClientId = '') => {
 ...
 */
const getClientIdsOfDescendants = exports.getClientIdsOfDescendants = (0, _rememo.default)((state, rootIds) => {
...
const getGlobalBlockCount = exports.getGlobalBlockCount = (0, _rememo.default)((state, blockName) => {
 ...
 */
const getBlocksByName = exports.getBlocksByName = (0, _rememo.default)((state, blockName) => {
  if (!blockName) {
    return EMPTY_ARRAY;
  }
 ...
 */
const getBlocksByClientId = exports.getBlocksByClientId = (0, _rememo.default)((state, clientIds) => (Array.isArray(clientIds) ? clientIds : [clientIds]).map(clientId => getBlock(state, clientId)), (state, clientIds) => (Array.isArray(clientIds) ? clientIds : [clientIds]).map(clientId => state.blocks.tree.get(clientId)));
 ...
 */
const getBlockNamesByClientId = exports.getBlockNamesByClientId = (0, _rememo.default)((state, clientIds) => getBlocksByClientId(state, clientIds).filter(Boolean).map(block => block.name), (state, clientIds) => getBlocksByClientId(state, clientIds));
 ...
 */
const getBlockParents = exports.getBlockParents = (0, _rememo.default)((state, clientId, ascending = false) => {
  const parents = [];
 ...
 * @return {Array} ClientIDs of the parent blocks.
 */
const getBlockParentsByBlockName = exports.getBlockParentsByBlockName = (0, _rememo.default)((state, clientId, blockName, ascending = false) => {
 ...
 */
const getSelectedBlockClientIds = exports.getSelectedBlockClientIds = (0, _rememo.default)(state => {
  const {
    selectionStart,
    selectionEnd
  } = state.selection;
 ...
 */
const getMultiSelectedBlocks = exports.getMultiSelectedBlocks = (0, _rememo.default)(state => {
 ...
 *                   set.
 */
const isAncestorMultiSelected = exports.isAncestorMultiSelected = (0, _rememo.default)((state, clientId) => {
 ...
 */
const getBlockInsertionPoint = exports.getBlockInsertionPoint = (0, _rememo.default)(state => {
 ...
 * @return {boolean} Whether the given block type is allowed to be inserted.
 */
const canInsertBlockType = exports.canInsertBlockType = (0, _rememo.default)(canInsertBlockTypeUnmemoized, (state, blockName, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId), state.settings.allowedBlockTypes, state.settings.templateLock, state.blockEditingModes]);
...
const buildBlockTypeItem = (state, {
  ...
  const ignoredHookedBlocks = [...new Set(Object.values((0, _blocks.getHookedBlocks)(id)).flat())];
  return {
    ...blockItemBase,
 ...
 */
const getInserterItems = exports.getInserterItems = (0, _rememo.default)((state, rootClientId = null) => {
...
}, (state, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId), state.blocks.order, state.preferences.insertUsage, state.settings.allowedBlockTypes, state.settings.templateLock, getReusableBlocks(state), (0, _blocks.getBlockTypes)()]);
 ...
 * @property {number}          frecency     Heuristic that combines frequency and recency.
 */
const getBlockTransformItems = exports.getBlockTransformItems = (0, _rememo.default)((state, blocks, rootClientId = null) => {
...
}, (state, blocks, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId), state.preferences.insertUsage, state.settings.allowedBlockTypes, state.settings.templateLock, (0, _blocks.getBlockTypes)()]);
 ...
 */
const hasInserterItems = exports.hasInserterItems = (0, _rememo.default)((state, rootClientId = null) => {
...
}, (state, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId), state.settings.allowedBlockTypes, state.settings.templateLock, getReusableBlocks(state), (0, _blocks.getBlockTypes)()]);
 ...
 */
const getAllowedBlocks = exports.getAllowedBlocks = (0, _rememo.default)((state, rootClientId = null) => {
  if (!rootClientId) {
    return;
  }
...
const __experimentalGetAllowedBlocks = exports.__experimentalGetAllowedBlocks = (0, _rememo.default)((state, rootClientId = null) => {
 ...
 */
const getDirectInsertBlock = exports.getDirectInsertBlock = (0, _rememo.default)((state, rootClientId = null) => {
  if (!rootClientId) {
    return;
  }
...
const __experimentalGetDirectInsertBlock = exports.__experimentalGetDirectInsertBlock = (0, _rememo.default)((state, rootClientId = null) => {
...
const __experimentalGetParsedPattern = exports.__experimentalGetParsedPattern = (0, _data.createRegistrySelector)(select => (0, _rememo.default)((state, patternName) => {
  const {
    getAllPatterns
...
const getAllowedPatternsDependants = (state, rootClientId) => {
  return [...(0, _utils.getAllPatternsDependants)(state), state.settings.allowedBlockTypes, state.settings.templateLock, state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId)];
};
...
const __experimentalGetAllowedPatterns = exports.__experimentalGetAllowedPatterns = (0, _data.createRegistrySelector)(select => {
  return (0, _rememo.default)((state, rootClientId = null) => {
    const {
      getAllPatterns,
 ...
 */
const getPatternsByBlockTypes = exports.getPatternsByBlockTypes = (0, _data.createRegistrySelector)(select => (0, _rememo.default)((state, blockNames, rootClientId = null) => {
 ...
 */
const __experimentalGetPatternTransformItems = exports.__experimentalGetPatternTransformItems = (0, _data.createRegistrySelector)(select => (0, _rememo.default)((state, blocks, rootClientId = null) => {
 ...
 */
const __experimentalGetBlockListSettingsForBlocks = exports.__experimentalGetBlockListSettingsForBlocks = (0, _rememo.default)((state, clientIds = []) => {
 ...
 */
const __experimentalGetReusableBlockTitle = exports.__experimentalGetReusableBlockTitle = (0, _rememo.default)((state, ref) => {
 ...
 */
const __experimentalGetActiveBlockIdByBlockNames = exports.__experimentalGetActiveBlockIdByBlockNames = (0, _rememo.default)((state, validBlockNames) => {
 ...
 */
const __unstableGetVisibleBlocks = exports.__unstableGetVisibleBlocks = (0, _rememo.default)(state => {
 ...
 */
const __unstableGetContentLockingParent = exports.__unstableGetContentLockingParent = (0, _rememo.default)((state, clientId) => {
  let current = clientId;
  let result;
  while (current = state.blocks.parents.get(current)) {
