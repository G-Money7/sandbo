...
const getAllPatterns = exports.getAllPatterns = (0, _data.createRegistrySelector)(select => (0, _rememo.default)(state => {
  ...
  return [...userPatterns, ...__experimentalBlockPatterns, ...(0, _lockUnlock.unlock)(select(_constants.STORE_NAME)).getFetchedPatterns()].filter((x, index, arr) => index === arr.findIndex(y => x.name === y.name));
