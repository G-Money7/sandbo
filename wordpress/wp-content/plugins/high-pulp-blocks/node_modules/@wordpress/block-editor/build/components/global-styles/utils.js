...
/* Supporting data. */
const ROOT_BLOCK_NAME = exports.ROOT_BLOCK_NAME = 'root';
const ROOT_BLOCK_SELECTOR = exports.ROOT_BLOCK_SELECTOR = 'body';
const ROOT_BLOCK_SUPPORTS = exports.ROOT_BLOCK_SUPPORTS = ['background', 'backgroundColor', 'color', 'linkColor', 'captionColor', 'buttonColor', 'headingColor', 'fontFamily', 'fontSize', 'fontStyle', 'fontWeight', 'lineHeight', 'textDecoration', 'textTransform', 'padding'];
