...
function BorderPanel({
  ...
  const mergedShadowPresets = shadowPresets ? (0, _getBlockSettings.mergeOrigins)(shadowPresets) : [];
  ...
  const label = (0, _border.getBorderPanelLabel)({
    blockName: name,
    hasShadowControl,
  ...
  return (0, _react.createElement)(Wrapper, {
    ...
    as: "legend"
  }, (0, _i18n.__)('Shadow')), (0, _react.createElement)(_components.__experimentalItemGroup, {
    isBordered: true,
    isSeparated: true
